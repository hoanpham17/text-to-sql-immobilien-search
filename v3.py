...
# --- Giai đoạn 1: Kết nối Database và đọc Schema ---
...
# --- Giai đoạn 3.1: Định nghĩa danh sách các mô hình khả dụng ---
        ...
        for table_name, columns in tables.items():
            ...
            for col in columns:
                ...
                if col.get('primary_key'):
                    details.append("PK")
                # Kiểm tra explicit False vì giá trị có thể là None 
...
default_uri = os.getenv("DATABASE_URI", "postgresql://postgres.vpxiurybdchpvgvbumtv:213456@aws-0-eu-central-1.pooler.supabase.com:5432/postgres") # Lấy từ env nếu có, hoặc dùng default
